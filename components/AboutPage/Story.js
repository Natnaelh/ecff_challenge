...
export default function Story() {
  const StoryData = [
    { year: 2001, text: "" },
    {
      path: "/images/nathan-dumlao-KixfBEdyp64-unsplash.jpg",
      year: 2005,
        ...
        <div className="flex flex-col md:grid ">
          ...
          <div className="odd:justify-self-end mb-10 md:mb-0">
            <div className="flex items-center w-96 h-96">
              ...
              <div className="hidden md:inline absolute md:right-[30%] lg:right-[40%] py-5 px-10 bg-slate-200 rounded-full">
                2005
              </div>
              <div className="flex flex-col h-full">
                <Image
