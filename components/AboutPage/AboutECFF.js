    ...
    <div className="flex flex-col w-full mb-40 px-5 md:px-96">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <div className="flex flex-col w-130">
          <h1 className="text-ecffBrown font-bold text-4xl md:text-5xl my-4">
            We are ECFF
          </h1>
        ...
        <div className="relative flex flex-row md:flex-col mt-10 md:mt-0">
          <div className="w-96 h-96 project-one-background bg-cover bg-center mx-10"></div>

          <div className="md:absolute w-96 h-96 md:w-72 md:h-72 project-two-background bg-cover bg-center md:-bottom-1/4 md:-right-1/4"></div>
        </div>
      </div>
